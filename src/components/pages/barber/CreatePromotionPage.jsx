...
function PromotionsAdminPage() {
  ...
  const fetchPromotions = async () => {
    try {
      setLoading(true)
      const res = await axios.get(`${api}/api/barber/promotions`, {
  ...
  const handleCreate = async (e) => {
    ...
    setCreating(true)
    try {
      await axios.post(`${api}/api/barber/promotions`, form, {
        headers: { Authorization: `Bearer ${token}` },
      })
  ...
  const deactivatePromotion = async (id) => {
    ...
    try {
      await axios.patch(
        `${api}/api/barber/${id}/promotions/deactivate`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      )
  ...
  const deletePromotion = async (id) => {
    setActionLoading(id)
    try {
      await axios.delete(`${api}/api/barber/${id}/promotions`, {
        headers: { Authorization: `Bearer ${token}` },
      })
